...
//                0,
//            OffsetDateTime.parse("2020-01-01T09:00+02:00"),
//            OffsetDateTime.parse("2020-01-01T12:00+02:00"),
//            projects[0].id,
//            null,
//            false
//        ),
//        DatabaseWorktimeEntry(
//            0,
//            OffsetDateTime.parse("2020-01-01T12:30+02:00"),
//            OffsetDateTime.parse("2020-01-01T15:00+02:00"),
//            projects[1].id,
//            null,
//            false
//        ),
...
//            0,
//            OffsetDateTime.parse("2020-01-01T15:00+02:00"),
//            OffsetDateTime.parse("2020-01-01T17:00+02:00"),
//            projects[2].id,
//            null,
//            false
//        ),
//        DatabaseWorktimeEntry(
//            0,
//            OffsetDateTime.parse("2020-01-02T09:00+02:00"),
//            OffsetDateTime.parse("2020-01-02T12:00+02:00"),
//            projects[0].id,
//            null,
//            false
//        ),
//        DatabaseWorktimeEntry(
//            0,
//            OffsetDateTime.parse("2020-01-02T12:30+02:00"),
//            OffsetDateTime.parse("2020-01-02T15:00+02:00"),
//            projects[1].id,
//            null,
//            false
//        ),
...
//            0,
//            OffsetDateTime.parse("2020-01-02T15:00+02:00"),
//            OffsetDateTime.parse("2020-01-02T17:00+02:00"),
//            projects[2].id,
//            null,
//            false
//        )
...
//        assertEquals("2020-01-01T09:00+02:00", entriesFromDb[0].startedAt.toString())
//        assertEquals("2020-01-01T12:00+02:00", entriesFromDb[0].endedAt.toString())
//    }
//
//    @Test
//    @Throws(Exception::class)
...
//        assertEquals("2020-01-01T09:00+02:00", entriesFromDb[0].startedAt.toString())
//        assertEquals("2020-01-01T12:30+02:00", entriesFromDb[1].startedAt.toString())
//        assertEquals("2020-01-01T15:00+02:00", entriesFromDb[2].startedAt.toString())
//    }
//
//    @Test
//    @Throws(Exception::class)
...
//            startedAt = OffsetDateTime.parse("2020-01-02T12:30+02:00"),
//            endedAt = OffsetDateTime.parse("2020-01-02T15:00+02:00"),
...
//        assertEquals("2020-01-02T12:30+02:00", updatedEntry?.startedAt.toString())
//        assertEquals("2020-01-02T15:00+02:00", updatedEntry?.endedAt.toString())
